...
from model import HybridCausalDiffusion
...
class Trainer:
    def __init__(self, config):
        ...
        self.model = HybridCausalDiffusion(config, device=self.device)
    ...
    def train_one_step(self, batch):
        ...
        if "ode_latent" not in batch:
            raise ValueError("Hybrid trainer requires precomputed ode_latent in the batch")
